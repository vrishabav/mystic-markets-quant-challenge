"""
Iteration 10: Valyrian VWM(2, 6)
Isolating Valyrian's peak length (6 bars) with a 2-bar Volume-Weighted envelope, 
while maintaining baseline parameters for remaining assets.
"""
...
def strategy_Valyrian_Steel(bar, _s={"c": [], "v": []}):
    ...
    # sum2, diff6
    val = (_s["c"][-1] - _s["c"][-7]) * _s["v"][-1] + (_s["c"][-2] - _s["c"][-8]) * _s["v"][-2]
